...
Important: The screenshots in previous context are outdated. This is the current v4 application. Open the live site in a browser, inspect routes, state, data loading, bottom nav, gallery/hunt flow, map views, detail sheets/panels, themes, and any Studio/Batches surface. Explore user journeys end-to-end: gallery -> hunt -> map -> detail.
